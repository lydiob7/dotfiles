...
-- Center screen when jumping with <C-u> / <C-d> / <C-f> / <C-b>
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if client and client.name == 'emmet_ls' then
            map('<C-y>,', '<cmd>lua vim.lsp.buf.execute_command({command = "emmet.expandAbbreviation", arguments = {}})<CR>', 'Emmet Expand Abbreviation')
          end
        end,
      })
      ...
      local servers = {
        ...
        emmet_ls = {
          filetypes = { 'html', 'css', 'javascript', 'javascriptreact', 'sass', 'scss', 'less', 'php', 'liquid' },
          init_options = {
            html = {
              options = {
        ...
        intelephense = {
          settings = {
            intelephense = {
              environment = {
                includePaths = {
                  vim.fn.getcwd() .. '/wp-includes',
                  vim.fn.getcwd() .. '/wp-admin/includes',
                },
              },
            },
          },
